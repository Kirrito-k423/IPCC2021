...
double itime, ftime,f1time, f2time, f3time, f4time,f5time;
...
int main (int argc, char **argv)
{
	...
	printf("\nTime taken is %f %f PerformSuperpixelSegmentation_VariableSandM", f4time-itime,f4time-f3time);
	printf("\nTime taken is %f %f PerformSuperpixelSegmentation_VariableSandM 循环", f5time-itime,f5time-f4time);
	printf("\nTime taken is %f %f EnforceLabelConnectivity", ftime-itime,ftime-f5time);
